...
public class populateProducts {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            String sqlStatement = "CREATE TABLE products (productID INT PRIMARY KEY, productName VARCHAR, orderPrice MONEY, sellPrice MONEY, currentStock FLOAT, desiredStock FLOAT)";
            stmt.execute(sqlStatement);
            ...
            stmt.execute(sqlStatement);
            sqlStatement = "GRANT ALL ON products TO csce315950_2user";
            stmt.execute(sqlStatement);
            ...
            try {
                ...
                while (line != null) {
                    ...
                    String productID = colValues[0];
                    String productName = colValues[1];
                    ...
                    sqlStatement = "INSERT INTO products (productID, productName, orderPrice, sellPrice, currentStock, desiredStock) VALUES(";
                    sqlStatement += "'" + productID + "', '" + productName + "', '" + orderPrice + "', '" + sellPrice + "', '" + currentStock + "', '" + desiredStock + "')";
