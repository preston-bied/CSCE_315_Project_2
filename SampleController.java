...
public class SampleController {
	...
	public void cashierLaunch(ActionEvent event) throws IOException {
		launchScene("cashierScene.fxml", event);
	}
	
	
	/** 
	 * @param dbConnectionString contains SQL to connect to database
	 * @param queryProduct contains name of selected product type
	 * @throws IOException if scene fails to load
	...
	public void cashierChickenQuery(ActionEvent event) throws IOException, SQLException {
		...
		cashierQuery(dbConnectionString, "Chicken");
	}	
	 ...
	 * @throws SQLException if database fails to connect
	 */
	public void cashierBeefQuery(ActionEvent event) throws IOException, SQLException {
		
		String dbConnectionString = dbConnection.connectToDatabase();
		cashierQuery(dbConnectionString, "Beef");
	 ...
	 * @throws SQLException if database fails to connect
	 */
	public void cashierPorkQuery(ActionEvent event) throws IOException, SQLException {
		
		String dbConnectionString = dbConnection.connectToDatabase();
		cashierQuery(dbConnectionString, "Pork");
	}	
	...
	public void managerOrders(ActionEvent event) throws IOException {		
		...
		launchScene("managerCreateOrder.fxml", event);		
	}
	/**
	 * 
	...
	public void managerInventoryLaunch(ActionEvent event) throws IOException {		
		//System.out.println("Launched manager order page");
		launchScene("managerInventory.fxml", event);	
	}
	/**
	 * 
	...
	public void managerHistoryLaunch(ActionEvent event) throws IOException {		
		//System.out.println("Launched manager order page");
		launchScene("managerHistory.fxml", event);	
	}
